...
# Mostramos el menú al usuario y le pedimos respuesta .
    ...
    if respuesta > 0 and respuesta < 4:
        if respuesta != 3:
            if respuesta == 1:
                ...
                # Hacemos los cálculos del área y el perímetro del cuadrado .
                areaCuadrado = lado**2
                ...
                # Pedimos al usuario las medidas de la base y de la altura.
